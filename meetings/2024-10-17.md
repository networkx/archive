# NetworkX Developer Discussions: Oct 17, 2024
...
**In attendance**: Erik, Dan, Jarrod, Ross, Derek, Mridul, Matt

## Welcome and news

- New Meeting time Thursdays at 6pm UTC.
- NX 3.4.1 released Oct 11. (but we need 3.4.2 -- see below) 
...
- Lets get a NetworkX Summit set for early 2025. 
    - Where? Caltech? UC Berkeley?
...
- We might see an increased volume of classwork/hacktoberfest style of PRs
  * Not much to do necessarily, other than be aware!

## 3.4 Release
- The stable docs don't include backend info as of 3.4.1. It is fixed on `main`. 
    - Can we update the docs without a new release?
    - Should make a new release, so the 3.4.x backend code loads `backend_info` into the docs?
    - [Jarrod] It's simplest just to make a new release -- and the release numbers are free.
- Result: We will make a 3.4.2 release as soon as practical.
...
## Topics
- Add something about AI driven development in our docs? Atleast gives us a quick way to point towards while closing suspect PRs?
    - (okay to use them for help but atleast follow the developer docs first).
- Visualization PRs:
...
- [SPECs](https://scientific-python.org/specs/)
    ...
    - [SPEC 2: api dispatch](https://scientific-python.org/specs/spec-0002/)
        - https://github.com/scikit-image/scikit-image/issues/7550
-    Benchmarking CI job
