# NetworkX Developer Discussions: Nov 14, 2024
...
**In attendance**: Rick, Erik, Dan, Mridul, Ross, Derek, Aditi, Jarrod
...
- [Publicly available analytics for our docs pages](https://views.scientific-python.org/networkx.org) are now available!
  * rossbar (and others co-located) having issues with views.scientific-python.org, including javascript hanging on networkx.org - [issue 7719: javascript not loading](https://github.com/networkx/networkx/issues/7719) 
  * Definitely a caltech network issue - can't reach `views.scientific-python.org` in any capacity (even e.g. pinging)
- Numfocus board elections (Results Nov 22)
- Numfocus small developer grants (Nov 14?)
...
- [PyData NYC Nov 6-8](https://ti.to/pydata/pydata-nyc-2024). Rick and Anthony. Rick will be speaking Friday am.
- NetworkX Summit tentative planning: Feb? 2025, UC Berkeley.
- [PyData Global 2024](https://pydata.org/global2024/) (online) - Dec 3-5, 2024. Aditi : [talk - "Understanding API Dispatching in NetworkX"](https://global2024.pydata.org/cfp/talk/review/7UNTUMFBMSFJUZUMXGZ9JBVXVVTXCZVQ)
...
- Do we allow a small-ish neural network model to be one of our generators? [PR 7663 : smallish brain network model](https://github.com/networkx/networkx/pull/7663)  as a new generator? What policy should we have about adding new generators. Maybe "small" and cited in multiple literature papers. Or maybe "not in a public database easily accessible"?
    - Sounds like we don't want to add smallish networks based on datasets. It is hard to know where to draw the line -- but we prefer analytical construction and/or classic graphs with history. We have some that are not like that. But we hold our noses for the sake of backward compatibility.
...
-    Benchmarking CI job
      * Not sure if it's working: [logs](https://github.com/networkx/networkx/actions/runs/10364115584/job/28688937688?pr=7595)
      ...
      * One comprehensive collection of datasets is the [network repository](https://docs.rapids.ai/deployment/stable/developer/ci/github-actions/) which is really useful for getting one of many graphs for benchmarking.
- updating the landing page 
    - what's the issue with https://github.com/MridulS/nx-website-sp-hugo?  It is not intended as a finished landing page. It is an exercise to show what it could look like.
    - Hugo might not be used in the future. Will swicth to myst, but not for a while.
...
- Local community detection: https://github.com/networkx/networkx/pull/7691 :tada: Merged!

- Faster random_k_out_graph: https://github.com/networkx/networkx/pull/7702 :tada: Merged!
  * Python & numpy implementation - how to handle?
...
- Visualization PRs:
    - [#7571 Saving layouts on the graph](https://github.com/networkx/networkx/pull/7571) (Needs Review)
