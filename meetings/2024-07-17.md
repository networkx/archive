# NetworkX Developer Discussions: July 17, 2024

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.
Meeting link: https://colgate.zoom.us/j/92619161786

**In attendance**: Dan, Erik, Mridul, Matt, Aditi

## Welcome and news
  - [**SciPy 2024**](https://www.scipy2024.scipy.org), Tacoma, WA July 8 - 14, 2024
    - **Attending:** Dan, Rick, Aditi(remotely)
...
## Upcoming meetings
  ...
  - **PyData Amsterdam** Sep 18-20 
      - **Attending:** Aditi
      - Submissions:
          - "Building a Parallel Backend for a graph analysis library using Python `entry_points`"
...
- Forceatlas2 layout: https://github.com/networkx/networkx/pull/5392
    ...
    - Dan worked on setting min/max of pos and fix random_state but still working.
