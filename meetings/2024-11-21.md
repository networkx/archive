# NetworkX Developer Discussions: Nov 21, 2024
...
**In attendance**: Derek, Erik, Ross, Mridul, Dan, Aditi
...
- Numfocus small developer grants: Aditi and Derek both got their SDG applications approved! :tada: 
    - Aditi will be working with dispatching of scikit-image
    - Derek will be working with NetworkX on benchmarking tools (see topics)
- Fabio Zanini (from igraph) contacted us about possibly creating a separate graph drawing package, designed to work well with both igraph and networkx. He spent last year rewriting the igraph code and he says that code is fairly independent of igraph or networkx. It is also constrained by backward compatibility issues in igraph. So he wants to see if there is interest in a separate project that would work for both. The present version currently  has backends Cairo and matplotlib.
...
- [PyData Global 2024](https://pydata.org/global2024/) (online) - Dec 3-5, 2024. Aditi : [talk - "Understanding API Dispatching in NetworkX"](https://global2024.pydata.org/cfp/talk/V8BYBM/)
...
-    Benchmarking CI job
      ...
      * Derek was awarded a Small Developer Grant to NumFOCUS to support development of a benchmarking system that can compare Graph Algorithms across implementations! :tada:
