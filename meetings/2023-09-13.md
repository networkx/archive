# NetworkX Developer Discussions: September 13, 2023

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.

**In attendance:** Jarrod, Stefan, Ross, Rick, Dan, Dylan, Francisco
...
- Benchmarking: regression in 3.12?
  ...
  * Ping pyperformance folks about the open PR?
  
- What should `join_trees` do re: attribute defaults?
  * https://github.com/networkx/networkx/issues/6910
...
- Adding data to the source repo:
  * https://github.com/networkx/networkx/pull/6893
    - Also doublecheck gallery build timing
