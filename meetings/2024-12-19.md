# NetworkX Developer Discussions: Dec 19, 2024
...
**In attendance**: Dan, Rick, Ralph, Erik, Ross, Derek
...
- NetworkX Summit tentative planning: Feb <10 2025, UC Berkeley.

## Topics

- Benchmarking CI job
    * now feature complete -- looking for bugs. Take a look!  
        * 6-7 tests so far. need more
        * preliminary results it may be hard to make blanket statements about which backend is better for all conditions. It may be more complicated than that.
        * should we look into swapping out asv for something more flexible. asv helps with manipulation of the system parameters. But it is built for comparing across commits. We have hacked it to vary other parameters. But it feels hack-y.
        * another pipelining tool could replace asv. 
        * Ross will provide hardware for further exploration.
    * nxbench https://github.com/dPys/nxbench/
    * Now has Readthedocs too.
...
NSF POSE with NASCol: https://nascol.discourse.group/t/nsf-pose-take-two/65
