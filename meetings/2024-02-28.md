# NetworkX Developer Discussions: February 28, 2024

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.
Meeting link: https://colgate.zoom.us/j/92619161786

**In attendance**: Jarrod, Ross, Rick, Dan, Mridul, Matt, Erik, Anthony

## Welcome and news

- Sentry donation hasn't arrived in opencollective yet, but might still be processing.  
- GSOC: we have been accepted into the NumFOCUS projects for GSOC. So it should be similar to previous years.
- Tidelift email about enabling 2FA - did anyone else get this? (Yes -- Dan got it, emailed Arliss who was the only one without 2FA. It is fixed now.)
...
- NX 3.3 (tentatively scheduled for March 29, 2024)
    ...
    - Dispatching PRs might need merging before release (and before talks)
    - check whether the geopandas gallery examples can be reactivated
      * Will require a contextily release
      * To test, revert [#7299](https://github.com/networkx/networkx/pull/7299) and see if circleci passes
        - Note however that the failures were intermittent!

- Upcoming dates/conferences:
    - NetSci https://netsci2024.com/en/satellites June 16-21 Québec City, Canada
      - "Would NetworkX would be able to send someone to NetSci this year who could teach (or better: co-teach) a workshop on network analysisin Python using multiple different packages (igraph, NetworkX, etc.)."
    - SciPy 2024 (Seattle)
    ...
    - NumFOCUS small developer grant deadline March 1. With funding for Aditi -- or maybe we could use the existing SDG from last year.(https://numfocus.org/programs/small-development-grants)
    - PyData London (Erik talk) June 15-16 CFP March 4

## Follow-up from last week

- Nightlys uploader
  * Action has been bumped (twice) - keep an eye on but should be good!

## Topics

- Reproducibility issue (intermittently failing seeded test) for aTSP: https://github.com/networkx/networkx/issues/5913
  * Potential differences in underlying scipy code (e.g. HiGHS solver for linprog)
  * Folks experiencing this issue are all linux distro package maintainers

- reverse-cuthill-mckee followup
  * Closed proposal to deprecate; details: https://github.com/networkx/networkx/issues/7287
  * Opportunity to explicitly implement a reverse-ordering algorithm, hopefully as a generator!
    - rossbar will open issue for this

- Test failure on pandas nightlies: https://github.com/rossbar/networkx/actions/runs/8034082386/job/21945242713
  * Should fix before 3.3

- Fixing missing intersphinx targets: https://github.com/networkx/networkx/pull/7313
  * rossbar's quick take-away: merge to fix intersphinx, open follow-up issue (low priority) to investigate replacing with automodule
  * Let's merge!

- NumPy 2.0 scalars cleanup
  * Lots of progress, any new discussion points?
