# NetworkX Developer Discussions: May 9th, 2023

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.

**In attendance:** Dan, Jarrod, Navya, Mridul, Jim
...
- Did we accidentally remove Kelly from commit rights? Double check...
  ...
  * [name=Mriduls] - will make poll for new meeting time, can start with new time ~mid May!
      * Some good times: Thursday 10pm PDT, **Wed 11am PDT** or Tues 9am PDT
    * We'll try Wed 11am PDT starting next week.
  
- Fix up circleci status redirector API token 
    - Status?  (these notes from last week)
  * [x] nx-guides
  * [x] pygraphviz
  * [ ] networkx
