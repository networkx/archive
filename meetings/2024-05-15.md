# NetworkX Developer Discussions: May 15, 2024

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.
Meeting link: https://colgate.zoom.us/j/92619161786

**In attendance**: Mridul, Aditi, Rick, Dan, Matt, Ross

## Welcome and news

- `pygraphviz` release: 1.13 Released! :tada:
- `nx-parallel` release: 0.2 Released! :tada:
...
- Forceatlas2 layout: https://github.com/networkx/networkx/pull/5392
  * rossbar took a look - appear to be some changes that were marked as "resolved" but weren't reflected - pinged contributor to make sure the PR branch is on the correct commit
...
- Deprecations! Timing to merge?  (maybe after numpy 2.0 is released, in case larger changes are needed to 3.3 -> 3.3.1)
  ...
  * Edmonds and MultiDiGraph_EdgeKey are up (thanks @mjschwenne !)
...
- random_tree: directedness?
  ...
  * add example to doc_string of how to convert to a directed tree.
    - First crack at this: https://github.com/networkx/networkx/pull/7449
...
- This seems neat (Convex Partitioning): https://github.com/networkx/networkx/discussions/7446

- next meeting: coloring algs
