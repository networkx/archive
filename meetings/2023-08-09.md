# NetworkX Developer Discussions: August 2nd, 2023

Change title of the HackMd document. Need owner (Ross?) to change the title?
 - [x] Yup!

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.

**In attendance:** Matt Schwennesen, Erik Welch, Ross Barnowski, Nilo Rivera, Rick Ratzel, Dylan Chima-Sanchez, Paula Perez Bianchi, Dan Schult, Mridul Seth
...
* Benchmarking
    ...
    * NetworkX asv benchmarks https://github.com/networkx/nx-benchmarks
        * [name=MridulS] Need to move this into main networkx repo.

* New PRs that might have questions:
  - broadcasting: https://github.com/networkx/networkx/discussions/6824
  - PlanarEmbedding methods `remove_*`. Doesn't have working `add_edge`. Do we make this more like a full class?
  - 3D drawing
  - ValueError vs NetworkXError in cd_index
  - multigraph edge drawing
  - voting based centrality
    * How does this compare to `voterank`
...
- Position attribute in geometric generators
...
- [#6688](https://github.com/networkx/networkx/pull/6688)
Is close to being merged.  What else? Anybody want to take a look?  
- Dan would like to go through the comments and add issues to address the items this "code audit" pointed out.  So, please don't "resolve" the conversations just yet.
