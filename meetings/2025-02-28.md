# NetworkX Developer Discussions: Feb 28, 2025
...
**In attendance**: Erik, Ralph, Dan, Ross, Aditi, Rick
...
- All the things that can happen with `contracted_nodes`
  * Just a docs PR: https://github.com/networkx/networkx/pull/7856
  * Should we make it possible to drop the `contraction` attribute creation?
