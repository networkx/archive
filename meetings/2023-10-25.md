# NetworkX Developer Discussions: October 25th, 2023

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.

**In attendance:** Rick, Ross, Dan, Erik

## Welcome and news

- Networkx v3.2 release :rocket: 
- CZI EOSS Round 6 LOIs submitted
...
- 3.2 release fallout
  * Python pinning on Conda forge
    - Mridul has responded. Resolved?
  * `could_be_isomorphic` behavior change
    - Dan figured out and patched (along with another instance in similarity)
    - Fix: https://github.com/networkx/networkx/pull/7041
  * `importlib.resources` with Python 3.8
    - Reported by distro maintainers who need to support Python 3.8
    - Suspect issue is in `importlib_resources` back-compat shim? Not clear
  * SyntaxWarning on import for Poetry user
    - https://github.com/networkx/networkx/issues/7032
    - Potentially poetry-specific? SyntaxWarning present in e.g. tests but not
      at import time

  * Do we need a patch release?
      * Yes -- let's fix them or determine that we won't and then release 3.2.1 or similar.

- Developer installation - anyone else having intermittent problems with running the test suite in a dev environment?
  * https://github.com/networkx/networkx/issues/7047
      * Let's explore and try to find a way to turn this error into a failed test, or a warning of some sort instead of halting the entire testing process.
...
- Lots of new feature proposals!
  * cluster_layout: [#6923](https://github.com/networkx/networkx/pull/6923)
    ...
    - Gallery example PR: [#7058](https://github.com/networkx/networkx/pull/7058)
