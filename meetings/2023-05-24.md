# NetworkX Developer Discussions: May 24th, 2023

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.

**In attendance:** Matt, Navya, Kelly, Erik, Paula, Ross, Jarrod, Dan
...
- Scientific Python Summit
    - Should we have anything networkx specific for the summit?
      * types
          * Mridul had a discussion with community members and the focus turned to the need to do a NX namespace review and whether we should use protocols:
...
- girth function: https://github.com/networkx/networkx/pull/6633
    - new bfs_labeled_edges probably should have been another PR but here we are.  Please comment.
