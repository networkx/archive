# NetworkX Developer Discussions: January 10th, 2024

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.

**In attendance Dan, Rick, Jarrod, Ross, Aditi, Erik, Mridul
...
- Upcoming conferences:
  ...
  * PyCon US - May 17-19 (Pittsburgh, PA)
...
- **Discussion**: Renaming `_dispatch` -> `_dispatchable`: thoughts?
  * see [#7189](https://github.com/networkx/networkx/issues/7189) and [#7193](https://github.com/networkx/networkx/pull/7193)
  * Fix conflicts and put it in!

- **Needs decision**: [#3709](https://github.com/networkx/networkx/pull/3709) adding two chemistry topology indexes closely related to the wiener index.
    - lets do it. :)

- **Quick Sync-up**: `sort_neighbors` API for DFS & BFS [#7196](https://github.com/networkx/networkx/pull/7196)
  - Ready for final review!
  
- **Discussion**: Kneser graph generator and what to do about GPL reference [#7146](https://github.com/networkx/networkx/pull/7146)
  - Someone comment to re-focus us on the graph instead of the GPL discussion
...
- [#6560](https://github.com/networkx/networkx/pull/6560) Add gallery example for `find_cycles`
