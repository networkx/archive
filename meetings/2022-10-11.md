# NetworkX Developer Discussions: October 11th, 2022

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.

**In attendance:** Ross, Mridul, Matt, Jarrod
...
- Try to get a beta out ASAP for testing against downstream projects (esp. scikit-image)

- Good first issues: See if there are opportunities to expand the list for
  the outreachy applicants
  * Coverage
