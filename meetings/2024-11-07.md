# NetworkX Developer Discussions: Nov 7, 2024
...
**In attendance**:Erik, Matt, Dan, Ross, Mridul, Aditi
...
- [Publicly available analytics for our docs pages](https://views.scientific-python.org/networkx.org) are now available!
  * rossbar having issues with views.scientific-python.org, including blocking on networkx.org - will open issue 
...
- Local community detection: https://github.com/networkx/networkx/pull/7691

- Faster random_k_out_graph: https://github.com/networkx/networkx/pull/7702
  * Python & numpy implementation - how to handle?

- [SPECs](https://scientific-python.org/specs/)
    - SPECs 6 and 8 are now officially endorsed by NetworkX.
