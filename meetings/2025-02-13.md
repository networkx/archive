# NetworkX Developer Discussions: Feb 13, 2025
...
**In attendance**: Dan Schult, Rick Ratzel, Audun Myers, Erik Welch, Ross Barnowski
...
We should send out a schedule finding email to reselect times for our meetings.
...
- Sustainability Lab continues through this year with Aditi as point person.
- Numfocus DISC unconference - submit project ideas by the end of Feb.
...
- Discussion about the OSS sustainability labs' need-finding interview.
...
- More isomorphism:
  - Proposal to refactor `could_be_isomorphic` and friends
