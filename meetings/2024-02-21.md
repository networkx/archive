# NetworkX Developer Discussions: February 21, 2024

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.
Meeting link: https://colgate.zoom.us/j/92619161786

**In attendance**: Dan, Ross, Erik, Rick, Aditi, Matt

## Welcome and news

- Sentry's full donation! ![Screenshot 2024-02-21 at 12.41.50 PM](https://hackmd.io/_uploads/HyLf83Q36.png)
Payout of $64 has been initiated, and should show in opencollective in 4-5 business days.  
...
- NX 3.3 (tentatively scheduled for March 29, 2024)
    - Numpy timeline ~6 weeks for RC.
    - only PR that might be affected is NEP 51
    - Dispatching PRs might need to merged before release (and before talks)
...
- NX-as-API
  * Leiden is a good test case: backends implement, NX has no native implementation
  * Pay close attention to signature + ref docs
...
- Geospatial examples consistently failing in CI
  ...
  * Currently disabled for sphinx-gallery. Need to revisit before 3.3 release.
