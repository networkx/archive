# NetworkX Developer Discussions: April 17, 2024

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.
Meeting link: https://colgate.zoom.us/j/92619161786

**In attendance**: Mridul, Ross, Erik, Rick, Matt, Dan, Jarrod, Aditi
...
- NumFOCUS won a UDPR case against the Memgraph folks, we are supposed to get the networkx.guide domain sometime.
    - Jarrod needs to coordinate with Stefan about setting up a nx vault for handling credentials (like domain registrations)

- New time for NX dispatching meeting.
...
- Public archive networkx-metis?
  * If Jarrod is here, otherwise we can skip!
...
- Numpy 2.0 tracking issue: https://github.com/numpy/numpy/issues/26191

- Deprecations!
  * Missed a removal for 3.3: `forest_str`
    - should be able to go in now regardless of 3.3 patch!
  ...
  * Left as draft PRs until we're sure that a 3.3 patch won't be necessary. One removal per PR: minor annoying merge conflicts, but easier to revert if necessary!
    - [`forest_str` (3.3)](https://github.com/networkx/networkx/pull/7414)
    - [`random_tree`](https://github.com/networkx/networkx/pull/7415)
      * NOTE: depends on [#7411](https://github.com/networkx/networkx/pull/7411) - review this one first!
    - [`sort_neighbors` param of `generic_bfs_edges`](https://github.com/networkx/networkx/pull/7417)
    - [`normalized` param of `s_metric`](https://github.com/networkx/networkx/pull/7418)
    - [`nx.join`](https://github.com/networkx/networkx/pull/7419)
    - [`strongly_connected_components_recursive`](https://github.com/networkx/networkx/pull/7420)
...
- Warnings from `to_networkx_graph` due to dependencies
  * https://github.com/networkx/networkx/issues/7401
