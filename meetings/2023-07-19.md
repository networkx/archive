# NetworkX Developer Discussions: July 5th, 2023

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.

**In attendance:** Dan, Matt, Erik

We talked about what projects are actively being pursued at the moment. Interest in dispatching and status of typing was expressed. Questions about what the group of us who will be at Scipy next week could do. It would be good to have a focus to those conversations too. Other topics mentioned were benchmarking, api improvements for traveling salesman and isomorphism parts of the code, and taking a deeper dive into the visualization parts, initiating/expanding temporal graph algorithms.

For SciPy meeting group meeting, maybe we could talk about what needs focus over the next 6 months and then also over the next 1-2 years. What should we aim for in v4.0?
...
Scipy 1.11 bugs and pinned version (no 1.11.0 or 1.11.1)
...
- PyGraphViz 1.11 released :tada: https://pypi.org/project/pygraphviz/1.11/
  - swig 4.1.1 update
  - misc updates
...
- `scipy.sparse` [index downcasting bug in 1.11](https://github.com/scipy/scipy/issues/18603)
  ...
  - could/should we use large sparse networks from a database to test scipy-sparse as well as NX on networkx on big graphs. (TAMU Time Davis  http://sparse.tamu.edu/) Cron-job? -- slow but maybe useful.
