# NetworkX Developer Discussions: July 24, 2024

Previous meeting notes available [here](https://github.com/networkx/archive/tree/main/meetings). Please feel free to add topics for discussion and news items below.
Meeting link: https://colgate.zoom.us/j/92619161786

**In attendance**: Dan, Mridul, Rick, Erik, Aditi, Matt
...
- Forceatlas2 layout: https://github.com/networkx/networkx/pull/5392
    ...
    - rossbar opened https://github.com/networkx/networkx/pull/7543 and has now finished :tada: working through/adding back comments from previous reviews
    - Dan worked on setting min/max of pos and fix random_state but is still working.
...
- Deprecations! :tada:  all removals for this release have been merged.
### Dispatch Topic
